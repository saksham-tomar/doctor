...
export default function Card({ props }: { props: SlideProps }) {
    ...
    <div className="flex relative flex-col min-w-52 rounded-2xl shadow-xl bg-gradient-to-bl from-indigo-50 to-indigo-100">
      <div className="mx-2 flex flex-row items-center mt-2">
        ...
        <div className="flex flex-col gap-2">
          <Image
            className="rounded-xl ring-1 ring-gray-400"
            src={avImage}
            alt="pic"
            width={80}
            height={80}
          />
          <p className="px-2 max-w-12 ml-auto text-white font-semibold py-0 flex items-center justify-center rounded-xl bg-green-500 text-xs">
            {props.speciality}
          </p>
        </div>
      </div>
      ...
      <div className="felx flex-row gap-4">
        <button
          ...
          className="px-6 ml-2 items-center mb-4 mt-2 bg-white py-1 hover:bg-gray-100 rounded-2xl ring-1 ring-gray-300 flex gap-2"
        >
          ...
          <p className="text-xs font-medium mr-auto">Book Now</p>
        </button>
