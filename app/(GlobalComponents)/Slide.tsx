  ...
  return (
    <div className="flex flex-row  gap-4 bg-gradient-to-tr from-indigo-50 to-indigo-200 min-w-80 items-center rounded-xl shadow-lg md:min-w-[700px] lg:min-w-[990px] justify-between pr-4">
      ...
      <div className="flex flex-col ml-2 py-2 justify-center">
        <h1 className="mb-1 font-semibold text-lg">{props.lastname}</h1>
        <p className="font-light text-sm">
          {props.specialization} | {props.hospital}
        </p>
      </div>
      <Drawer>
        <DrawerTrigger>
          ...
          <div className="flex flex-col justify-center mx-2 mt-2 items-center">
            ...
            <div className="flex flex-row gap-4 justify-between">
              <div className="flex flex-col lg:text-lg font-semibold">
                ...
                <p className="text-xs font-light">{`${props.specialization} | ${props.hospital}`}</p>
              </div>
